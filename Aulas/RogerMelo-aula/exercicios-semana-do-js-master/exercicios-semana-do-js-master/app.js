...
const randomNumbersImpares = randomNumbers.filter(randomNumbers => randomNumbers % 2 === 1) 

//console.log(randomNumbersImpares);
...
const numerosAbaixode501 = crazyNumbers.reduce((accumulator, crazyNumber) => {
...
//console.log(numerosAbaixode501);
...
const numberPotencia = numbers.map(number => number ** 2)
